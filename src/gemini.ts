...
- 실제 집에서 만들어본 것처럼 친근하고 편안한 구어체 반말 섞인 존댓말로 작성 (예: "~했어요", "~하더라구요"). "-습니다/-입니다" 격식체는 쓰지 말고 "-어요/-네요" 체로 통일하세요.
- 이모지를 적당히 섞어서 가독성 있게.
...
[공통 규칙]
- 실제 방문/경험 후기처럼 친근하고 편안한 구어체 반말 섞인 존댓말로 작성 (예: "~했어요", "~하더라구요"). "-습니다/-입니다" 격식체는 쓰지 말고 "-어요/-네요" 체로 통일하세요.
- 이모지를 적당히 섞어서 가독성 있게.
...
- "총평" 섹션 뒤에는 그 외 다른 내용을 절대 추가하지 마세요 (평점 기준표는 앱이 자동으로 붙입니다). 본문 마지막 줄에 해시태그도 쓰지 마세요 (앱이 별도로 붙입니다).`;
  ...
  return `- 실제 방문/경험 후기처럼 친근하고 편안한 구어체 반말 섞인 존댓말로 작성 (예: "~했어요", "~하더라구요"). "-습니다/-입니다" 격식체는 쓰지 말고 "-어요/-네요" 체로 통일하세요.
- 이모지를 적당히 섞어서 가독성 있게.
- 문단 사이는 빈 줄로 구분해서 네이버 블로그 에디터에 바로 붙여넣기 좋게.
...
- 존댓말 기반이지만 친근한 구어체 ("~해요", "~네요" 등), 이모지는 1~2개 정도만 자연스럽게 사용. "-습니다/-입니다" 격식체는 쓰지 마세요.
